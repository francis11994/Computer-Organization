...
PROGRAM:
	.word	0x20080100         # addi    $t0, $zero, 256
	.word	0x20090010         # addi    $t1, $zero, 16
	.word	0x200a0001         # addi    $t2, $zero, 1
	.word	0x200b1000         # addi    $t3, $zero, 4096
	.word	0x200c0200         # addi    $t4, $zero, 512
	.word	0x200d0020         # addi    $t5, $zero, 32
	.word	0x200e0002         # addi    $t6, $zero, 2
	.word	0x200f2000         # addi    $t7, $zero, 8192
	.word	0x20100400         # addi    $s0, $zero, 1024
END_PROGRAM:
