...
PROGRAM:
	.word	0x20080001         # addi   $t0, $zero, 1
	.word	0x20090002         # addi   $t1, $zero, 2
	.word	0x200a0003         # addi   $t2, $zero, 3
	.word	0x200b0004         # addi   $t3, $zero, 4
	.word   0x0c000006         # jal        LABEL_1
	.word   0x0800000a         # j          LABEL_3

	                           # LABEL_1:
	.word   0x08000008         # j          LABEL_2
	.word	0x200c0005         # addi   $t4, $zero, 5

	                           # LABEL_2:
	.word	0x200d0006         # addi   $t5, $zero, 6
...
main:
	...
	#     s7 - PC offset (0xc000_0000)

	addi    $s7, $zero, 0xc           # s7 = 0xc000_0000
	sll     $s7, $s7, 28
...
.text
	...
	sub     $t0, $s5, $s7             # t0 = PC (minus offset)
	slt     $t0, $t0, $zero           # t0 = PC < 0
	bne     $t0, $zero, main_PC_INVALID

	sub     $t0, $s5, $s7             # t0 = PC (minus offset)
	slt     $t0, $t0, $s2             # t0 = PC < programSize
