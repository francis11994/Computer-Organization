...
PROGRAM_TEST_01:
	...
	.word	0x01008020         # add    $s0, $t0, $zero 
	.word	0x02098820         # add    $s1, $s0, $t1 
	.word	0x022a9020         # add    $s2, $s1, $t2 
	.word	0x024b9820         # add    $s3, $s2, $t3 
END_PROGRAM_TEST_01:
...
main:
	...
	la      $s0, REGS_TEST_01         # s0 = &regs

	la      $s1, PROGRAM_TEST_01      # s1 = &program_start

	la      $s2, END_PROGRAM_TEST_01
	sub     $s2, $s2, $s1             # s2 = &program_end - &program_start

	la      $s3, MEMORY_TEST_01       # s3 = &program_start

	la      $s4, END_MEMORY_TEST_01
